...
export interface AuraVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "addStrategy"
      | "allowance"
...
export interface AuraVault extends BaseContract {
  connect(runner?: ContractRunner | null): AuraVault;
  waitForDeployment(): Promise<this>;

  interface: AuraVaultInterface;
  ...
  reportProfit: TypedContractMethod<
    [_profitAmount: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "reportProfit"
  ): TypedContractMethod<[_profitAmount: BigNumberish], [void], "nonpayable">;
  getFunction(
